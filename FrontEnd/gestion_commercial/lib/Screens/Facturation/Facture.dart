...
class FactureTable extends StatefulWidget {
  var idEntreprise;
  FactureTable({this.idEntreprise});

  @override
  _FactureTableState createState() => _FactureTableState();
}
            ...
            children: [
              ...
              child:Row(children: [
               Expanded(
                  ...
                  child: Text('Facture',style:TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Barlow')),
                )),
               Spacer(flex:1),
                   ...
                   children: [
                     Row(
                       children: [
                         Padding(
                           padding: const EdgeInsets.only(left:8.0),
                           child: Text('Les Factures',style:TextStyle(fontSize: 19,fontWeight: FontWeight.bold, fontFamily: 'Barlow')),
                         ),
                       ],
...
Padding(
  ...
  child:   ElevatedButton.icon( onPressed: () { 
   ...
   },icon: Icon(Icons.add), label:Text ('Editer Facture'),style: ElevatedButton.styleFrom(primary: Colors.primaryColor )),
),
              ...
              DataRow(cells: [
               ...
               child:Row(
                 ...
                 Padding(
                   ...
                   }, icon: Icon(Icons.transform_rounded), label:Text ('Transformé en Bon de livraison',),style: ElevatedButton.styleFrom(primary: Colors.blue[900] )),
                 ),
 ...
 StatefulWidget showEditDialog(){
    return
      StatefulBuilder(
              ...
              child: Text('Nouveau Facture',style:TextStyle(fontSize: 25,fontWeight: FontWeight.bold, fontFamily: 'Barlow')),
